...
/// <summary>
/// LsyWater mostly for planar reflection and its blur
/// </summary>
public class LsyWater : MonoBehaviour {
	public Camera cam;
	public Camera refCam;
	public Material matRefBlurMat;
	public int blurIteration = 1;
	public float blurLength = 1; 
	...
	void CreateCam()
	{
        ...
        refCam.allowMSAA = false;
        refCam.allowHDR = false;
		...
		LsyWaterRefCam lsyWaterRefCam = refCam.gameObject.AddComponent<LsyWaterRefCam> ();
		lsyWaterRefCam.mat = matRefBlurMat;
		lsyWaterRefCam.iter = blurIteration;
		lsyWaterRefCam.length = blurLength;
	}

	void OnDestroy()
	{
		reflTex.Release ();
		Object.Destroy (reflTex);
		reflTex = null;
	}
	...
	void CreateRT()
	{
		...
		reflTex.name = "Lsy RT-Complex Water reflection " + GetInstanceID();
