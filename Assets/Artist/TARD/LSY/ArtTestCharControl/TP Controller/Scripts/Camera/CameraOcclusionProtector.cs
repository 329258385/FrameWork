...
{
	public float MIN_DISTANCE_TO_PLAYER = 1f;
	public float MAX_DISTANCE_TO_PLAYER = 5f;
	...
	public float distanceScollSpeed = 2f; // In meters
	...
	void Update()
	{
		var scrollV = Input.GetAxis ("Mouse ScrollWheel");
		distanceToTarget += scrollV * distanceScollSpeed;
		distanceToTarget = Mathf.Clamp (distanceToTarget, MIN_DISTANCE_TO_PLAYER, MAX_DISTANCE_TO_PLAYER);
	}
}
