require "behavior3_lua.behavior3"
...
local err
file, err = io.open("Assets/LuaScripts/behavior3_lua/MonsterBehavior.json", "rb")
if file == nil then
	print("Unable to read MonsterBehavior.json "..err)
end
...
if data == nil then
	print("Failed to read MonsterBehavior.json")
else
	print(data)
	behaviorTree:load(data, {})
	print("------------------------------------------------")
