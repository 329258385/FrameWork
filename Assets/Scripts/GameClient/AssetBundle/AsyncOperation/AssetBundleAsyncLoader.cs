...
namespace AssetBundles
{
    ...
    public class AssetBundleAsyncLoader : BaseAssetBundleAsyncLoader
    {
        ...
        /// 先不考虑使用对象池子
        /// </summary>
        public AssetBundlePackage _assetprefab;
        ...
        override public object AssetObject()
        {
            if (_assetprefab != null)
                return _assetprefab.AssetObject();
            return null;
        }
        ...
        public override void Update()
        {
            ...
            _assetprefab.Update();
            isOver      = _assetprefab.IsLoadOver();
            if (isOver)
            {
                /// 这里可能要多处理一些东西，因为少一个 request层，
                _assetprefab.AddAssetsCache();
            }
        }
